...
namespace CityInfoApi.Controllers
{
    ...
    public class PointOfIntrestController : ControllerBase
    {
        ...
        public PointOfIntrestController(ILogger<PointOfIntrestController> logger, IMailService mailService, ICityInfoRepository cityInfoRepository, IMapper mapper)
        {
